...
<div class="container light-style flex-grow-1 container-p-y" style="margin-top: 25px;">
    <h4 class="font-weight-bold  py-3 mb-4" style="font-size: 1.5rem;">
        Account settings
    </h4>
                        ...
                        <div class="tab-pane fade active show" id="account-general">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-1" value="{{ old('name', $user->name) }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-1" value="{{ old('email', $user->email) }}">
                                </div>
                                <!-- Pindahkan konten Info ke sini -->
                                <div class="form-group">
...
<script>
  document.getElementById('logoutBtn').addEventListener('click', function(event) {
    ...
    if (!confirmLogout) {
      event.preventDefault(); // Batalkan logout jika pilih "Cancel"
    }
  });
</script>
