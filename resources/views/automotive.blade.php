...
<section class="p-6 bg-white">
  <div class="grid grid-cols-2 sm:grid-cols-4 gap-6">
    ...
    <!-- @php
      $products = [
        ['image' => 'velg.jpeg', 'name' => 'Velg', 'price' => '105.000,00'],
        ['image' => 'audio-mobil.png', 'name' => 'Car Audio', 'price' => '400.000,00'],
        ['image' => 'tape.jpg', 'name' => 'Car Tape', 'price' => '75.000,00'],
        ['image' => 'knalpot mobil.jpg', 'name' => 'Exhaust', 'price' => '125.000,00'],
        ['image' => 'headlamp-1-1024x617.jpg', 'name' => 'Headlamp', 'price' => '100.000,00'],
        ['image' => 'Wheels.jpg', 'name' => 'Wheels', 'price' => '95.000,00'],
