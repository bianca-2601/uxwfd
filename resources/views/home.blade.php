...
<section class="p-8">
  ...
  <div class="grid grid-cols-2 md:grid-cols-4 gap-6" >
    <div class="bg-white rounded-lg shadow overflow-hidden transition-all duration-300 hover:shadow-lg cursor-pointer" onclick="window.location.href='{{ route('woman') }}'">
      ...
      <div class="p-4 text-center font-semibold text-gray-800 hover:rounded cursor-pointer" >Woman Clothing & Accessories</div>
    </div>

    <div class="bg-white rounded-lg shadow overflow-hidden transition-all duration-300 hover:shadow-lg cursor-pointer" onclick="window.location.href='{{ route('carpentry') }}'">
      <div class="h-44 overflow-hidden">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden transition-all duration-300 hover:shadow-lg cursor-pointer" onclick="window.location.href='{{ route('electronics') }}'">
      <div class="h-44 overflow-hidden">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden transition-all duration-300 hover:shadow-lg cursor-pointer" onclick="window.location.href='{{ route('furniture') }}'">
      <div class="h-44 overflow-hidden">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden transition-all duration-300 hover:shadow-lg cursor-pointer" onclick="window.location.href='{{ route('kitchen') }}'">
      <div class="h-44 overflow-hidden">
        <img src="{{ asset('images/kitchenware.jpg') }}" class="w-full h-full object-cover" alt="">

      </div>
      <div class="p-4 text-center font-semibold text-gray-800 hover:rounded cursor-pointer"  >Kitchen Items</div>
      {{-- Masukin abis kitchen dibuat --}}
        
    </div>

    <div class="bg-white rounded-lg shadow overflow-hidden transition-all duration-300 hover:shadow-lg cursor-pointer" onclick="window.location.href='{{ route('sports') }}'">
      <div class="h-44 overflow-hidden">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden transition-all duration-300 hover:shadow-lg cursor-pointer" onclick="window.location.href='{{ route('books') }}'">
      <div class="h-44 overflow-hidden">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden transition-all duration-300 hover:shadow-lg cursor-pointer" onclick="window.location.href='{{ route('automotive') }}'">
      <div class="h-44 overflow-hidden">
  ...
  <div class="mt-8 text-center"> <!-- mt-8 untuk margin top, text-center untuk posisi tengah -->
    <button 
      class="px-6 py-3 bg-white text-yellow-500 rounded border-2 border-yellow-500 hover:bg-yellow-50 transition-colors duration-300"
...
function carousel() {
  return {
    ...
    goToShop() {
      window.location.href = '{{ route('shop') }}'; // arahkan ke halaman shop
    },
    init() {
